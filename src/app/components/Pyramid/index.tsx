...
const Pyramid: FC = () => {
  return (
    ...
    lg:border-l-[70px] border-l-transparent
    lg:border-b-[120px] border-b-[#00555A]
    lg:border-r-[70px] border-r-transparent
    cursor-pointer hover:border-b-[#FCFF7F]   "
      >
        <div className=" flex items-center justify-center">
          ...
          <div className="absolute font-halyard left-7 top-0 w-[250px] mb-2 hidden group-hover:block text-xs text-white bg-[#00262B] p-4 pr-0 rounded">
            Your priority at this stage is focusing on what your desired
            distrubution is.
          </div>
        </div>
      </div>
      ...
      <div
        className="relative md:!w-[260px] sm:!w-[220px]  xxs:!w-[180px] h-0 group
        lg:border-l-[50px] border-l-transparent
        lg:border-r-[50px] border-r-transparent
        lg:border-b-[85px] border-b-[#00555A]
            cursor-pointer hover:border-b-[#FCFF7F] 
      ...
      >
        <div className="absolute top-10 left-0 right-0 bottom-0 flex items-center justify-center">
          ...
          <div className="absolute font-halyard w-[250px] left-32  bottom-full w-[200px] mb-2 hidden group-hover:block text-xs text-white bg-[#00262B] p-1 rounded p-4">
            Your priority at this stage is focusing on maximization, overcoming
            inflation, and diversifiying risk.
          </div>
        </div>
      </div>
      ...
      <div
        ...
        lg:border-b-[85px] border-b-[#00555A]
         ...
         md:!w-[380px] sm:!w-[320px] xxs:!w-[220px]
        "
      >
        <div className="absolute top-10 left-0 right-0 bottom-0 flex items-center justify-center ">
      ...
      <div
        ...
        lg:border-b-[85px] border-b-[#00555A]
        cursor-pointer hover:border-b-[#FCFF7F]
        sm:!w-[420px] md:!w-[500px] xxs:!w-[335px]
        "
      >
        <div className="absolute top-10 left-0 right-0 bottom-0 flex items-center justify-center">
