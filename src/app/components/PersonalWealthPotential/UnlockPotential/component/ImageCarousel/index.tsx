    ...
    <div className="relative h-full">
      <div className="lg:absolute inset-0 flex items-center justify-center">
        <img
          ...
          className="lg:!w-full xxs:w-[90%]"
        />
        <div className="absolute lg:top-[95px] top-[36px] left-0 space-y-3">
          <div className="flex justify-between items-center xxs:w-56 sm:w-72 bg-[#FCF8F5] xxs:p-3 sm:p-4 rounded-lg shadow-md">
            <div className="flex justify-center items-center gap-3">
              <Image
                ...
                className="w-6 h-6"
              />
              <p className="text-base text-[#00555A] font-medium ">
                Healthcare
              </p>
            </div>
            <div>
        ...
        <div className="absolute lg:top-[170px] xxs:left-6 sm:left-6 xxs:-top-[25px] sm:-top-[30px] space-y-3">
          <div className="flex justify-between items-center xxs:w-56 sm:w-72 bg-[#FCF8F5] xxs:p-3 sm:p-4 rounded-lg shadow-md">
            <div className="flex justify-center items-center gap-3">
              <Image
