...
const UnlockPotential = () => {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-[100px] px-5 lg:px-[160px] text-[#00262B] mt-[100px] lg:mb-[200px] sm:mb-[100px] xxs:mb-[230px] h-screen">
      <div className="flex flex-col justify-center w-full lg:order-2">
        ...
        <p
          className="text-lg mb-6 font-light-haylard mt-5 font-bold"
