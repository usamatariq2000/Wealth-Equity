  ...
  return (
    <section className="flex flex-col items-center lg:flex-row mb-10 lg:mb-0 text-[#00262B] ">
      <div className="w-full flex flex-col justify-center px-5 lg:px-16 mt-[50px] md:mt-[100px]">
        <b className="tracking-widest font-bold font-halyard leading-14 tracking-tighter text-left text-transform: uppercase my-4 text-[14px] lg:text-[16px]">
          {content.subheader}
        </b>
        <h1
          className="text-[45px] lg:text-[64px] leading-[50px] lg:leading-[72px] font-jubilee mb-6"
