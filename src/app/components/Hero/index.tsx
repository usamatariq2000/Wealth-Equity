...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row text-[#00262B]">
      <div className="w-full flex flex-col justify-center px-5 lg:px-16 ">
        <b className="tracking-widest font-bold font-halyard leading-14 tracking-tighter text-left text-transform: uppercase my-4">
          {content.subheader}
        </b>
        <h1
          className="text-[64px] font-jubilee mb-6"
          style={{ lineHeight: "72px", letterSpacing: "-2.5%" }}
        >
        ...
        <p className="text-lg mb-6 font-bold font-light-haylard">{content.description}</p>
