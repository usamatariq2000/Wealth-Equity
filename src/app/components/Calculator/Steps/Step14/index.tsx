...
const content = {
  header:
    "How much do you want to set aside for your final expenses?",
  description:
    "Your final expenses may include medical bills, legal fees. nursing home or hospice care, and burial or cremation costs",
};
const Step14: React.FC<QuizStepProps> = ({ answer, onChange }) => (
  <div>
    <div className="">
      <h1
