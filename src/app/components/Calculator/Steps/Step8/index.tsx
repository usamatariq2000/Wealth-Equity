...
const content = {
  header:
    "How much do you want to provide for extended healthcare?",
  description:
    "Setting aside money for healthcare can be crucial, especially if unexpected medical expenses arise.",
};
const Step8: React.FC<QuizStepProps> = ({ answer, onChange }) => (
  <div>
    <div className="">
      <h1
