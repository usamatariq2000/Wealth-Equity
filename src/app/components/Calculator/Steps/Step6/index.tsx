...
const content = {
  header:
    "How much debt do you want to eliminate for your family right away?",
  description:
    "Consider what obligation, if you paid off for your loved ones, would provide them with the most peace of mind.",
};
const Step6: React.FC<QuizStepProps> = ({ answer, onChange }) => (
  <div>
    <div className="">
      <h1
