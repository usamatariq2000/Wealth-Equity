  ...
  return (
    <div className="relative w-full h-screen">
      <div className="relative hidden lg:block w-full h-screen shadow-overlay">
        <Image
          src="/images/Senior Friends Portrait.jpg"
          alt="HeroImg"
          layout="fill"
          objectFit="cover"
      ...
      <div className="absolute inset-0 flex items-end mb-20 justify-center">
        ...
        <p className="text-sm sm:text-base lg:text-lg font-halyard-text xl:text-lg tracking-[1px] font-bold mb-4">
            “On average, women have a longer life expectancy than men, so <span className="text-[#FCFF7F] inline-block">{" "} planning for a longer coverage period</span> can ensure continued support
            for your loved ones.”
          </p>
