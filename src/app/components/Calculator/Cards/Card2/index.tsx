  ...
  return (
    <div className="relative w-full h-screen">
      <div className="relative hidden lg:block w-full h-screen shadow-overlay">
        <Image
          src="/images/Grandfather with Grandson.jpg"
          alt="HeroImg"
          layout="fill"
          objectFit="cover"
      ...
      <div className="absolute inset-0 flex items-end mb-20 justify-center">
        ...
        <p className="text-sm sm:text-base lg:text-lg font-halyard-text xl:text-lg tracking-[1px] font-bold mb-4">
            “The earlier you purchase life insurance, the lower the premium will
            be. In fact, every year you wait it could save you{" "}
            <span className="text-[#FCFF7F] inline-block">an extra 4-12%!”</span>
          </p>
          ...
          <img src={"/images/Ellipse 11.png"} alt={"card 1"} className="w-14 h-14 rounded-full mr-4" />
            <div>
              ...
              <p className="text-xs sm:text-sm lg:text-base">{content.title}</p>
            </div>
          </div>
        </div>
      </div>
