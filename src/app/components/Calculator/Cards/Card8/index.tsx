  ...
  return (
    <div className="relative w-full h-screen">
      <div className="relative hidden lg:block w-full h-screen shadow-overlay">
        <Image
          src="/images/Senior black male exercise fall.jpeg"
          alt="HeroImg"
          layout="fill"
          objectFit="cover"
      ...
      <div className="absolute inset-0 flex items-end mb-20 justify-center">
        ...
        <p className="text-sm sm:text-base lg:text-lg font-halyard-text xl:text-lg tracking-[1px] font-bold mb-4">
          “Think about <span className="text-[#FCFF7F] inline-block">current and future healthcare needs,</span> like long-term or nursing care. Evaluate any family history of chronic illnesses and possible costs.”
          </p>
